...
class EllaEvaluator:
    ...
    def classify_intent(self, query):
        system_prompt = (
            ...
            "INSTRUCTIONS:\n"
            "1. Use 'TRIAGE' for medical investigation.\n"
            "2. Use 'EMERGENCY' for life-threatening situations.\n"
            "3. Use 'BOOKING' for appointment scheduling.\n"
            "4. Use 'GENERAL_INFO' for non-clinical questions.\n"
            "5. Use 'CLOSING' ONLY for farewells (bye, goodbye, see you later).\n\n"
            "EXAMPLES:\n"
            "- 'bye' -> CLOSING\n"
            "- 'goodbye' -> CLOSING\n"
            ...
            "- 'What are the side effects of Lisinopril?' -> GENERAL_INFO"
        )
        try:
