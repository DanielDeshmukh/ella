...
def get_pinecone_index():
    ...
    if PINECONE_INDEX not in existing:
        console.print(f"[bold red]ERROR:[/bold red] Index '{PINECONE_INDEX}' not found. Run migration first.")
        return None
...
def ingest_medical_book(file_path: str):
    ...
    try:
        ...
        with console.status("[bold magenta]Storing in Pinecone...[/bold magenta]", spinner="bouncingBall"):
